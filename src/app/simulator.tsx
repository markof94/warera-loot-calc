...
const Simulator = () => {
  ...
  const [activeTab, setActiveTab] = useState<"daily" | "single">("daily");
  ...
  return (
    <div className="p-6 max-w-6xl min-w-6xl mx-auto">
      ...
      {/* Daily Batch Simulation Tab */}
      {activeTab === "daily" && (
        <div className="space-y-6">
          {/* Daily Simulation Section */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-xs text-gray-500 bg-gray-900 p-3 rounded">
                  <div>
                    Sessions per day: ~{Math.floor(24 / dailyRegenHours)}
                  </div>
                        ...
                        <tr className="border-b border-gray-700">
                          ...
                          <td className="py-2 text-right font-medium text-red-400">
                            ...
                            <span className="text-xs text-gray-500 ml-1">
                              (
                              {(
                                (dailyResults.avgHits /
                                  dailyResults.avgAttacks) *
                                100
                              ).toFixed(0)}
                              %)
                            </span>
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-yellow-400">
                        +$
                        {strategyComparison.recycleScrap.savedOnEquip.toFixed(
                          2
                        )}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="text-red-400">
                        -$
                        {strategyComparison.recycleScrap.effectiveCost.toFixed(
                          2
                        )}
                      </span>
                    </div>
